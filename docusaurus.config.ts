...
const config: Config = {
  ...
  organizationName: 'teppyboy', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: 'Ruan Mei',
        src: 'img/ruan-mei-character_icon.webp',
      },
      items: [
        {
          type: 'docSidebar',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} tretrauit & contributors. Built with Docusaurus.`,
    },
    prism: {
