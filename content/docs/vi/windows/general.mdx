...
+ [Sophia](../tweaks/sophia)
+ [Atlas OS](../tweaks/atlas-os)
...
To install it simply download the [batch file](https://github.com/teppyboy/nguyen-mai/blob/main/scripts/windows/25h2/Native%20NVMe%20Win11%20by%20Koekieezz%20and%20ZenKromaT-v1.2.bat?raw=1) and run and hope it works. If it doesn't then you're out of luck, try NOT to use a stripped version of Windows (modified ISO).
