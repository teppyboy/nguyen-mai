...
To install it simply download the <a href="/scripts/windows/25h2/Native%20NVMe%20Win11%20by%20Koekieezz%20and%20ZenKromaT-v1.2.bat" download>batch file</a> and run and hope it works. If it doesn't then you're out of luck, try NOT to use a stripped version of Windows (modified ISO).
